...
The Feedback Module. Responsible for any intents with feedback in their name.
    ...
    if intent_name == 'mail.feedback':
        ...
        return chip_response(
            text='Danke! Ich leite es weiter.\r\n '
        ...
        return button_response(
            text='Wenn du dich über etwas beschweren oder konstruktive Kritik äußern möchtest: \r\n'
        ...
        return button_response(
            text='Okay, hier ist unsere Telefonnummer für Anregungen und Kritik: \r\n'
                 '+49 221 29499139\r\n',
        ...
        return button_response(
            text='Okay, hier findest du das gesamte Team vom Sommerblut. \r\n'
        ...
        return chip_response(
            text='Okay, soll ich dir vielleicht einen Witz erzählen? \r\n',
